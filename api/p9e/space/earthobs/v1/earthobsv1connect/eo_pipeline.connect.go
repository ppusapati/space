...
const (
	...
	PipelineServiceName = "p9e.space.earthobs.v1.PipelineService"
)
...
const (
	...
	// RPC.
	PipelineServiceSubmitJobProcedure = "/p9e.space.earthobs.v1.PipelineService/SubmitJob"
	// PipelineServiceGetJobProcedure is the fully-qualified name of the PipelineService's GetJob RPC.
	PipelineServiceGetJobProcedure = "/p9e.space.earthobs.v1.PipelineService/GetJob"
	// PipelineServiceListJobsProcedure is the fully-qualified name of the PipelineService's ListJobs
	// RPC.
	PipelineServiceListJobsProcedure = "/p9e.space.earthobs.v1.PipelineService/ListJobs"
	// PipelineServiceUpdateJobStatusProcedure is the fully-qualified name of the PipelineService's
	// UpdateJobStatus RPC.
	PipelineServiceUpdateJobStatusProcedure = "/p9e.space.earthobs.v1.PipelineService/UpdateJobStatus"
	// PipelineServiceCancelJobProcedure is the fully-qualified name of the PipelineService's CancelJob
	// RPC.
	PipelineServiceCancelJobProcedure = "/p9e.space.earthobs.v1.PipelineService/CancelJob"
)

// PipelineServiceClient is a client for the p9e.space.earthobs.v1.PipelineService service.
...
// NewPipelineServiceClient constructs a client for the p9e.space.earthobs.v1.PipelineService
...
func NewPipelineServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) PipelineServiceClient {
	...
	pipelineServiceMethods := v1.File_p9e_space_earthobs_v1_eo_pipeline_proto.Services().ByName("PipelineService").Methods()
...
// SubmitJob calls p9e.space.earthobs.v1.PipelineService.SubmitJob.
...
// GetJob calls p9e.space.earthobs.v1.PipelineService.GetJob.
func (c *pipelineServiceClient) GetJob(ctx context.Context, req *connect.Request[v1.GetJobRequest]) (*connect.Response[v1.GetJobResponse], error) {
	return c.getJob.CallUnary(ctx, req)
}

// ListJobs calls p9e.space.earthobs.v1.PipelineService.ListJobs.
...
// UpdateJobStatus calls p9e.space.earthobs.v1.PipelineService.UpdateJobStatus.
func (c *pipelineServiceClient) UpdateJobStatus(ctx context.Context, req *connect.Request[v1.UpdateJobStatusRequest]) (*connect.Response[v1.UpdateJobStatusResponse], error) {
	return c.updateJobStatus.CallUnary(ctx, req)
}

// CancelJob calls p9e.space.earthobs.v1.PipelineService.CancelJob.
func (c *pipelineServiceClient) CancelJob(ctx context.Context, req *connect.Request[v1.CancelJobRequest]) (*connect.Response[v1.CancelJobResponse], error) {
	return c.cancelJob.CallUnary(ctx, req)
}

// PipelineServiceHandler is an implementation of the p9e.space.earthobs.v1.PipelineService service.
...
func NewPipelineServiceHandler(svc PipelineServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/p9e.space.earthobs.v1.PipelineService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedPipelineServiceHandler) SubmitJob(context.Context, *connect.Request[v1.SubmitJobRequest]) (*connect.Response[v1.SubmitJobResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("p9e.space.earthobs.v1.PipelineService.SubmitJob is not implemented"))
}

func (UnimplementedPipelineServiceHandler) GetJob(context.Context, *connect.Request[v1.GetJobRequest]) (*connect.Response[v1.GetJobResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("p9e.space.earthobs.v1.PipelineService.GetJob is not implemented"))
}
...
func (UnimplementedPipelineServiceHandler) ListJobs(context.Context, *connect.Request[v1.ListJobsRequest]) (*connect.Response[v1.ListJobsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("p9e.space.earthobs.v1.PipelineService.ListJobs is not implemented"))
}

func (UnimplementedPipelineServiceHandler) UpdateJobStatus(context.Context, *connect.Request[v1.UpdateJobStatusRequest]) (*connect.Response[v1.UpdateJobStatusResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("p9e.space.earthobs.v1.PipelineService.UpdateJobStatus is not implemented"))
}

func (UnimplementedPipelineServiceHandler) CancelJob(context.Context, *connect.Request[v1.CancelJobRequest]) (*connect.Response[v1.CancelJobResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("p9e.space.earthobs.v1.PipelineService.CancelJob is not implemented"))
}
