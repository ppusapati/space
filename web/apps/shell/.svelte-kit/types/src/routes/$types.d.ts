...
type LayoutRouteId = RouteId | "/" | "/(app)/approvals" | "/(app)/dashboard" | "/(app)/forms" | "/(app)/forms/[module]" | "/(app)/forms/[module]/[formId]" | "/(app)/forms/[module]/[formId]/submissions" | "/(app)/[domain]" | "/(app)/[domain]/[entity]" | "/(auth)/login" | null
type LayoutParams = RouteParams & { module?: string; formId?: string; domain?: string; entity?: string }
