...
import { BaseError, Action, ColorVariant } from './common.types.js';
/**
 * Generic View Type
 * @template TData - The data type for the view
 * @template TContext - Contextual information available to the view
 */
export interface View<TData = unknown, TContext extends Record<string, unknown> = Record<string, unknown>> {
    data: TData;
    context: TContext;
    isLoading: boolean;
    isEmpty: boolean;
 ...
 */
export interface TimelineView<TItem extends TimelineItem> extends View<TItem[], {
 ...
 */
export interface KanbanView<TItem extends KanbanItem, TColumn extends KanbanColumn> extends View<{
    columns: TColumn[];
    items: TItem[];
}, {
    draggedItem?: TItem;
 ...
 */
export interface CalendarView<TEvent extends CalendarEvent> extends View<TEvent[], {
    currentDate: Date;
 ...
 */
export interface TreeView<TNode extends TreeNode> extends View<TNode[], {
 ...
 */
export interface GalleryView<TItem extends GalleryItem> extends View<TItem[], {
    selectedId?: string;
 ...
 */
export interface ActivityFeedView<TActivity extends ActivityItem> extends View<TActivity[], {
 ...
 */
export interface StatisticsView<TMetric extends MetricItem> extends View<TMetric[], {
    dateRange?: {
        start: Date;
        end: Date;
    };
