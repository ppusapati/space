...
// Config is the eo-analytics configuration loaded from environment.
type Config struct {
	ServiceName     string
	Environment     string
	LogLevel        string
...
func Load() (Config, error) {
	...
	if dsn == "" {
		return Config{}, errors.New("eo-analytics: DATABASE_URL required")
	}
	return Config{
		ServiceName:     getenv("SERVICE_NAME", "eo-analytics"),
