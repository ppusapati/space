// Command eo-analytics is the EO ML model registry + inference job service.
package main
...
import (
	...
	"github.com/ppusapati/space/services/eo-analytics/internal/handler"
...
func run() error {
	...
	path, hndl := eoanalyticsv1connect.NewAnalyticsServiceHandler(h, connectOption)
