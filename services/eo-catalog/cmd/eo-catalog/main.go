// Command eo-catalog is the STAC catalog service.
package main
...
import (
	...
	"github.com/ppusapati/space/services/eo-catalog/internal/handler"
...
func run() error {
	...
	h, err := handler.NewCatalogHandler(svc)
	if err != nil {
		return err
	}
	...
	path, hndl := eocatalogv1connect.NewCatalogServiceHandler(h, connectOption)
