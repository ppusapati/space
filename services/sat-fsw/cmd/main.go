...
import (
	...
	"github.com/ppusapati/space/services/sat-fsw/internal/handler"
...
func run() error {
	...
	h, err := handler.NewFSWHandler(svc)
	if err != nil {
		return err
	}
	...
	path, hndl := satfswv1connect.NewFlightSoftwareServiceHandler(h, connectOption)
