...
// Config is the sat-fsw configuration loaded from environment.
type Config struct {
	ServiceName     string
	Environment     string
	LogLevel        string
...
func Load() (Config, error) {
	...
	if dsn == "" {
		return Config{}, errors.New("sat-fsw: DATABASE_URL required")
	}
	return Config{
		ServiceName:     getenv("SERVICE_NAME", "sat-fsw"),
