...
// Config is the sat-mission configuration loaded from environment.
type Config struct {
	ServiceName     string
	Environment     string
	LogLevel        string
...
func Load() (Config, error) {
	...
	if dsn == "" {
		return Config{}, errors.New("sat-mission: DATABASE_URL required")
	}
	return Config{
		ServiceName:     getenv("SERVICE_NAME", "sat-mission"),
