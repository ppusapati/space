// Command sat-mission is the satellite registry + mission control service.
package main
...
import (
	...
	"github.com/ppusapati/space/services/sat-mission/internal/handler"
...
func run() error {
	...
	h, err := handler.NewMissionHandler(svc)
	if err != nil {
		return err
	}
	...
	path, hndl := satmissionv1connect.NewMissionServiceHandler(h, connectOption)
