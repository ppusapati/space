// Command sat-telemetry is the satellite housekeeping ingest service.
package main
...
import (
	...
	"github.com/ppusapati/space/services/sat-telemetry/internal/handler"
...
func run() error {
	...
	h, err := handler.NewTelemetryHandler(svc)
	if err != nil {
		return err
	}
	...
	path, hndl := sattelemetryv1connect.NewTelemetryServiceHandler(h, connectOption)
