...
// Config is the eo-pipeline configuration loaded from environment.
type Config struct {
	ServiceName     string
	Environment     string
	LogLevel        string
...
func Load() (Config, error) {
	...
	if dsn == "" {
		return Config{}, errors.New("eo-pipeline: DATABASE_URL required")
	}
	return Config{
		ServiceName:     getenv("SERVICE_NAME", "eo-pipeline"),
