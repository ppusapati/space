// Command eo-pipeline is the processing-job orchestration ConnectRPC service.
package main
...
import (
	...
	"github.com/ppusapati/space/services/eo-pipeline/internal/handlers"
...
func run() error {
	...
	logger.Info("starting eo-pipeline",
	...
	handler := handlers.NewPipelineHandler(svc, []byte(cfg.CursorSecret))

	mux := http.NewServeMux()
	path, h := earthobsv1connect.NewPipelineServiceHandler(
		handler,
