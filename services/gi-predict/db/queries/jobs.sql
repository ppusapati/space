...
-- name: GetForecastJob :one
SELECT * FROM forecast_jobs WHERE id = $1;

-- name: CountForecastJobsForTenant :one
...
-- name: ListForecastJobsForTenant :many
...
-- name: UpdateForecastJobStatus :one
